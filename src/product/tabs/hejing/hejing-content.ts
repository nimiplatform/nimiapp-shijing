...
export const HEJING_RELATIONSHIP_WORKSPACES: readonly HeJingWorkspace[] = [
  {
    ...
    metrics: [
      ...
      { id: 'communication', label: '沟通顺畅度', value: 72, tone: 'blue', explanation: '整体顺畅，偶有情绪打断。' },
      { id: 'consistency', label: '规则一致性', value: 78, tone: 'gold', explanation: '规则清晰，执行需更稳定。' },
      { id: 'safety', label: '情绪安全感', value: 82, tone: 'green', explanation: '孩子感到被接纳与支持。' },
      { id: 'growth', label: '成长支持度', value: 88, tone: 'green', explanation: '持续鼓励，支持孩子探索。' },
