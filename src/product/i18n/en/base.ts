...
aiConfig: {
  ...
  description: 'Configure the ShiJing App text.generate intent used by Runtime AI wording and consultation',
  runtimeNotReady: 'Runtime not ready',
  runtimeUnavailable: 'Runtime unavailable',
  runtimeBootstrapPending: 'Runtime bootstrap is not complete.',
  needsTarget: 'Configuration needed',
  missingTarget: 'Missing text generation configuration',
  missingTargetDetail: 'ShiJing generation fails closed when its App AIConfig has no executable text.generate intent.',
