...
export const CULTURAL_MARKERS: readonly CulturalMarker[] = ['natal_yang', 'natal_yin', 'unspecified'] as const;

export type CalculationSex = 'male' | 'female' | 'unspecified';

export const CALCULATION_SEXES: readonly CalculationSex[] = ['male', 'female', 'unspecified'] as const;
